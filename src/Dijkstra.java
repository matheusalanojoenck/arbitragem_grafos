...
public class Dijkstra {
    ...
    public Dijkstra(LinkedList<LinkedList<Float>> matrizAdjPeso){
    ...
    private int minDistance(float[] estimativa, boolean[] visitado) {
        float min = Integer.MAX_VALUE;//pré defini a menor distancia como infinito
    ...
    private void printSolution(float[] estimativa, int[] precedente){
